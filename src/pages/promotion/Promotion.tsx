    ...
    <div className="relative">
      <div className="w-full h-52">
        ...
        <div className="absolute w-full px-4 top-4 left-0">
          <div className="bg-white flex items-center rounded-full px-3 w-full">
        ...
        <Flex
          align={"center"}
          className="absolute w-full px-4 top-52 -translate-y-1/2 left-1/2 -translate-x-1/2"
        >
          <Flex
            justify={"center"}
            align={"center"}
      ...
      <div className="p-4 mt-8">
        <Flex justify={"space-between"} align={"center"} className="">
          ...
          <div className="bg-[#C3E3D9] rounded-full px-3.5 py-0.5">
            <p className="text-primary">{t("promotion.see_all")}</p>
          </div>
        </Flex>
      ...
      <div className="mt-4">
        ...
        <div className="bg-[#C3E3D9] px-4 py-8">
            ...
            {redeemData.map((item, key) => (
              <Fragment key={item.id}>
                ...
                {redeemData.length !== key + 1 && (
                  <Divider color="teal" className="opacity-25" />
                )}
              </Fragment>
            ))}
          </Flex>
