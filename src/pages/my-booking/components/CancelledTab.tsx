    ...
    <div className="mt-4 p-4 rounded-xl bg-slate-100 border border-slate-200">
      <Flex justify={"space-between"} align={"center"}>
        ...
        <Flex
          justify={"center"}
          align={"center"}
          className="bg-red-500 px-3 py-2 text-white font-semibold rounded-lg text-sm"
        >
          <p>Cancelled</p>
        </Flex>
      </Flex>
      ...
      <Flex justify={"space-between"} align={"center"}>
        <div className="">
          <h2 className="font-semibold text-xl">MTP Parking 755 Kent Ave</h2>
          <p className="text-[#616161]">Brooklyn, 755 Kent Ave</p>
        </div>
        <NavigateIcon />
      </Flex>
      <Divider my={16} />
